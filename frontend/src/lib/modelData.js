  ...
  openai: [
    {
      ...
      label: 'GPT-5.5',
      status: 'latest',
      summary: 'OpenAI’s newest flagship model for complex reasoning, coding, and professional work.',
    ...
    },
    {
      ...
      label: 'GPT-5.5 pro',
      status: 'latest',
      summary: 'Higher-compute GPT-5.5 variant for the hardest reasoning and precision-sensitive work.',
      knowledgeCutoff: 'Dec 01, 2025',
      latestUpdate: 'Snapshot 2026-04-23',
    ...
    },
    {
      ...
      label: 'GPT-5.4 pro',
      status: 'current',
      summary: 'Previous high-compute GPT-5.4 variant for hard coding, agentic, and research tasks.',
    ...
    },
    {
      ...
      label: 'GPT-5.3-Codex',
      status: 'current',
      summary: 'OpenAI’s current specialized model for long-horizon agentic coding work.',
      knowledgeCutoff: 'Aug 31, 2025',
      latestUpdate: 'Current Codex model',
    ...
    },
    {
      ...
      label: 'GPT-4.1 nano',
      status: 'deprecated',
      summary: 'Deprecated GPT-4.1 nano option retained for historical routing and classification workloads.',
      knowledgeCutoff: 'Jun 01, 2024',
      latestUpdate: 'Deprecated; snapshot 2025-04-14',
    ...
    },
    {
      ...
      label: 'o4-mini',
      status: 'deprecated',
      summary: 'Deprecated smaller reasoning model retained for historical comparison; OpenAI lists GPT-5 mini as successor.',
      knowledgeCutoff: 'Jun 01, 2024',
      latestUpdate: 'Deprecated; snapshot 2025-04-16',
  ...
  gemini: [
    {
      ...
      status: 'preview',
      summary: 'Current Gemini 3-series preview for advanced reasoning, complex problem solving, and agentic coding.',
    ...
    },
    {
      ...
      status: 'preview',
      summary: 'Current Gemini 3 preview built for fast multimodal and agentic work at lower cost than Pro.',
      knowledgeCutoff: 'January 2025',
    ...
    },
    {
      ...
      status: 'latest',
      summary: 'Newest stable Gemini low-cost, high-frequency multimodal option for production use.',
      knowledgeCutoff: 'January 2025',
      latestUpdate: 'Stable as of May 10, 2026',
      versions: ['Stable: gemini-3.1-flash-lite', 'Preview: gemini-3.1-flash-lite-preview'],
      limits: { rpm: 'AI Studio', tpm: 'AI Studio', ctx: '1,048,576', out: '65,536', batch: '10M', tier: 'Stable / AI Studio' },
      source: {
        label: 'Gemini model page',
    ...
    },
    {
      ...
      status: 'preview',
      summary: 'Latest Gemini low-latency Live API preview for real-time voice-first dialogue.',
      knowledgeCutoff: 'January 2025',
    ...
    },
    {
      ...
      status: 'preview',
      summary: 'Latest Gemini speech-generation preview for low-latency text-to-speech.',
      knowledgeCutoff: 'January 2025',
    ...
    },
    {
      ...
      status: 'current',
      summary: 'Stable Gemini reasoning model still active today, with a documented shutdown window and a migration path to Gemini 3.1 Pro Preview.',
      knowledgeCutoff: 'January 2025',
      latestUpdate: 'Shutdown scheduled Jun 17, 2026',
    ...
    },
    {
      ...
      status: 'current',
      summary: 'Stable Gemini Flash model for low-latency, high-volume reasoning workloads that remains active today.',
      knowledgeCutoff: 'January 2025',
      latestUpdate: 'Shutdown scheduled Jun 17, 2026',
    ...
    },
    {
      ...
      status: 'current',
      summary: 'Stable Gemini Flash-Lite model still active today, with a documented migration path to Gemini 3.1 Flash-Lite.',
      knowledgeCutoff: 'January 2025',
      latestUpdate: 'Shutdown scheduled Jul 22, 2026',
    ...
    },
    {
      ...
      status: 'sunset',
      summary: 'Older stable Flash generation still available on May 10, 2026, but scheduled to shut down on June 1, 2026.',
      knowledgeCutoff: 'August 2024',
      latestUpdate: 'Shutdown scheduled Jun 1, 2026',
    ...
    },
    {
      ...
      status: 'sunset',
      summary: 'Older Lite generation still available on May 10, 2026, but scheduled to shut down on June 1, 2026.',
      knowledgeCutoff: 'August 2024',
      latestUpdate: 'Shutdown scheduled Jun 1, 2026',
