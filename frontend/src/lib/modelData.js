...
const MODEL_CATALOG = {
  claude: [
    {
      ...
      status: 'latest',
      summary: 'Anthropic’s most capable model for deep reasoning, agents, and coding.',
      knowledgeCutoff: 'May 2025',
      latestUpdate: 'Released Feb 5, 2026',
      versions: ['claude-opus-4-6'],
      limits: { rpm: 'See Console', tpm: 'Shared Opus pool', ctx: '200K / 1M beta', out: '128K', batch: 'See docs', tier: 'Anthropic usage tier' },
      source: {
    ...
    },
    {
      ...
      limits: { rpm: 'See Console', tpm: 'Shared Sonnet 4.x pool', ctx: '200K / 1M beta', out: '64K', batch: 'See docs', tier: 'Anthropic usage tier' },
      source: {
        label: 'Anthropic models overview',
        url: 'https://platform.claude.com/docs/en/about-claude/models/overview',
      },
    ...
    },
    {
      ...
      latestUpdate: 'Superseded Feb 5, 2026',
    ...
    },
    {
      ...
      latestUpdate: 'Superseded Feb 17, 2026',
  ...
  gemini: [
    ...
    },
    {
      ...
      knowledgeCutoff: 'January 2025',
      latestUpdate: 'Released Mar 31, 2026',
    ...
    },
    {
      ...
      knowledgeCutoff: 'January 2025',
      latestUpdate: 'Released Jun 17, 2025',
    ...
    },
    {
      ...
      knowledgeCutoff: 'January 2025',
      latestUpdate: 'Released Jul 22, 2025',
